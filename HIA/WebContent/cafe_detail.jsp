			...
			<div class="row">
				<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
					<div class="p-b-30 m-lr-15-sm">
						...
						<div class="flex-w flex-t p-b-68" id="listAjax">
							...
							<section id="pageList">
								<div id="pagebutton">
									...
									%>
									<input type="button" value="이전"
										onclick="location.href='cafeDetail.bo?cafe_num=<%=cafeBean.getCafe_num()%>&page=<%=commentNowPage - 1%>'">&nbsp;
									<%
										}
									%>
									<%
									...
									%>
									<a
										href="cafeDetail.bo?cafe_num=<%=cafeBean.getCafe_num()%>&page=<%=i%>">[<%=i%>]
									</a>&nbsp;
									<%
										}
									%>
						...
						%>
						<table class="w-full">
							<input type="hidden" name="cafe_num" id="cafe_num"
								value="<%=cafeBean.getCafe_num()%>" />
							...
							<div class="flex-w flex-m p-t-50 p-b-23">
								<span class="stext-102 cl3 m-r-16"> Your Rating </span> <span
									...
									class="item-rating pointer zmdi zmdi-star-outline"></i> <i
									class="item-rating pointer zmdi zmdi-star-outline"></i> <input
									class="dis-none" type="number" name="comment_rating"
									id="comment_rating">
								</span>
							</div>
							...
							<div class="row p-b-25">
								<div class="col-12 p-b-5">
									...
									<textarea class="size-110 bor8 stext-102 cl2 p-lr-20 p-tb-10"
										id="comment_content" name="comment_content"></textarea>
								</div>

								<div class="col-sm-6 p-b-5">
									<label class="stext-102 cl3" for="name">Name</label> <input
										class="size-111 bor8 stext-102 cl2 p-lr-20" id="comment_id"
										type="text" name="comment_id" value=<%=id%>>
								</div>
							</div>
							<div class="form-group">
								<input type="button" class="btn btn-primary pull-center"
									value="댓글쓰기" id="comment_add_btn">
							</div>
						</table>
						<%
							}

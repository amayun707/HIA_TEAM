...
CafeBean cafeBean = (CafeBean)request.getAttribute("cafeBean");
...
<body class="animsition">
	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-lg-7 p-b-30 DA9">
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								...
								<div class="item-slick3" data-thumb="images/detail2.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="images/detail2.jpg" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/detail2.jpg">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>

								<div class="item-slick3" data-thumb="images/detail3.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="images/detail3.jpg" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="images/detail3.jpg">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
...
<%-- 								카페소개 : <%=cafeBean.getCafe_info() %> --%>
				...
				<div class="tab01">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="#description" role="tab">Cafe Info</a>
						</li>

						<li class="nav-item p-b-10">
							<a class="nav-link" data-toggle="tab" href="#information" role="tab">Cafe Location</a>
						</li>

						<li class="nav-item p-b-10">
							<a class="nav-link active" data-toggle="tab" href="#reviews" role="tab">Reviews (<%=commentListCount %>)</a>
						</li>
					</ul>
							...
							<div class="row">
								<div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
									<div class="p-b-30 m-lr-15-sm">
										<!-- Review -->
										<div class="flex-w flex-t p-b-68" id="listAjax">
										<% for(int i = 0; i<commentList.size(); i++){ %>
											...
											<div class="size-207">
												<div class="flex-w flex-sb-m p-b-17"  id="commentfirst_line">
													<span class="mtext-107 cl2 p-r-20" id="comment_writer">
														<%= commentList.get(i).getComment_id()%>
													</span>
												...
												<p class="stext-102 cl6" id="comment_naeyong">
										...
										<%} %>	
											...
											<%} else {%>
												<input type="button" value="이전" onclick="location.href='cafeDetail.bo?cafe_num=<%=cafeBean.getCafe_num()%>&page=<%=commentNowPage - 1 %>'">&nbsp;
											<%} %>
											<%for(int i = commentStartPage; i <= commentEndPage; i++) { 
											if(i == commentNowPage) { %>
											[<%=i %>]
											<%} else { %>
											<a href="cafeDetail.bo?cafe_num=<%=cafeBean.getCafe_num()%>&page=<%=i %>">[<%=i %>]</a>&nbsp;
											<%} %>
											<%} %>
											...
											<%} else { %>
											<input type="button" value="다음" onclick="location.href='cafeDetail.bo?cafe_num=<%=cafeBean.getCafe_num()%>&page=<%=commentNowPage + 1 %>'">
											<%} %>
											</div>
											</section><br><br><br>
										</div>
										...
										<%if(id != null){ %>
										<table class="w-full">
										<input type="hidden" name="cafe_num" id="cafe_num" value="<%=cafeBean.getCafe_num()%>" />
										<input type="hidden" name="page" id="page" value="<%=nowPage %>" />
											...
											<div class="flex-w flex-m p-t-50 p-b-23">
												...
												<span class="wrap-rating fs-18 cl11 pointer">
													...
													<i class="item-rating pointer zmdi zmdi-star-outline"></i>
													<i class="item-rating pointer zmdi zmdi-star-outline"></i>
													<input class="dis-none" type="number" name="comment_rating" id="comment_rating">
												</span>
											</div>
											...
											<div class="row p-b-25">
												<div class="col-12 p-b-5">
													...
													<textarea class="size-110 bor8 stext-102 cl2 p-lr-20 p-tb-10" id="comment_content" name="comment_content"></textarea>
												</div>
		...
		<div class="bg6 flex-c-m flex-w size-302 m-t-73 p-tb-15 icons">
